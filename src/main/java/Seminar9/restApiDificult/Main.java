package Seminar9.restApiDificult;
    ...
    public static class UsersHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            if ("GET".equals(exchange.getRequestMethod())) {
                ...
                User newUser = new User(newId, "User.java" + newId);
                users.add(newUser);
                String responseBody = "User.java added: " + newUser;
                ...
                if (pathParts.length == 3) {
                    ...
                    String responseBody = "User.java with ID " + userId + " removed.";
                    exchange.sendResponseHeaders(200, responseBody.length());
                    try (OutputStream os = exchange.getResponseBody()) {
                        os.write(responseBody.getBytes());
                    }

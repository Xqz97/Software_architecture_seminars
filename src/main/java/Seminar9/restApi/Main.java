...
// Здесь мы обрабатываем только GET и POST мет оды.
...
// (хотя на самом деле мы просто отправляем строку "User.java added" в качестве ответа).
                String responseBody = "User.java added";
